...
const Home = () => {
  ...
  useEffect(() => {
    ...
    const filteredMobileProducts = products.filter(i => i.category === 'mobile');
    const filteredWirelessProducts = products.filter(i => i.category === 'wireless');
    const filteredPopularProducts = products.filter(i => i.category === 'watch');
